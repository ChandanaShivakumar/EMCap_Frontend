...
const Admin = () => {
    ...
    function getUsers() {
        fetch("https://emcapg.azurewebsites.net/employee").then((result) => {
    ...
    function getManagers() {
        fetch("https://emcapg.azurewebsites.net/api/managers/").then((result) => {
            result.json().then((resp) => {
                //console.log("result",resp)
                setData(resp)
            })
    ...
    function getUserTraining() {
        fetch("https://emcapg.azurewebsites.net/api/trainings/").then((result) => {
            result.json().then((resp) => {
                //console.log("result",resp)
    ...
    return (
        <div className="container5" style={{ backgroundColor: '#e6f5ff' }} key="{item.id}">
            ...
            {/* Background image */}
            <img src={require('./img1.png')} alt="cg logo" style={{ width: 300, height: 70, marginLeft: 400 }}></img>
            <div style={{ backgroundImage: `url(${require('./img5.webp')})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            ...
            <div style={{ textAlign: 'center' }}>
                <button className="btn btn-dark" onClick={() => myFunction1()}>Employee</button>&nbsp;
                <button className="btn btn-dark" onClick={() => myFunction2()}>Manager</button>&nbsp;
                <button className="btn btn-dark" onClick={() => myFunction3()}>Project</button>&nbsp;
                <button className="btn btn-dark" onClick={() => myFunction4()}>Training</button>&nbsp;
                <button className="btn btn-dark" onClick={() => myFunction5()}>POC</button>&nbsp;
            </div>
